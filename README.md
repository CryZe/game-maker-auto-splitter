# game-maker-auto-splitter

Experimental support for writing auto splitters for Game Maker games.
...
```
target/wasm32-unknown-unknown/release/game_maker_auto_splitter.wasm
```
